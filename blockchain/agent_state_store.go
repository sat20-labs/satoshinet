...
type AgentRuntimeFactory func(block *btcutil.Block, view *UtxoViewpoint) (*agent.RuntimeStore, error)
...
func (s *AgentStateStore) RuntimeFactory() AgentRuntimeFactory {
	return func(block *btcutil.Block, view *UtxoViewpoint) (*agent.RuntimeStore, error) {
		if block == nil {
