	...
	TxOut: []*wire.TxOut{
		{
			Value: 0,
			PkScript: []byte{
				0x51, 0x20, 0x1b, 0xd3, 0x05, 0xc7, 0x62, 0x23, 
        		0x1b, 0x60, 0x8b, 0xab, 0x32, 0xb1, 0x05, 0x63, 
        		0xb7, 0x03, 0xa0, 0x39, 0x8e, 0xb3, 0xdd, 0x5f, 
        		0x1b, 0x26, 0x6c, 0x56, 0x71, 0x59, 0x92, 0x1a, 
        		0xbd, 0x00, 
			},
		},
	},
...
var genesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:  time.Unix(1751454131, 0), // 2025-07-02 19:02:11.626325
		Bits:       0,                        // 0
		Nonce:      2466277953,
	},
	Transactions: []*wire.MsgTx{&genesisCoinbaseTx},
