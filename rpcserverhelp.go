...
var helpDescsEnUS = map[string]string{
	...
	"getblockverboseresult-contractStateRoot": "The committed combined contract state root, if present",
	...
	"getcontract--synopsis":                     "Returns basic information for a SatoshiNet contract address.",
	"getcontract-address":                       "The contract address",
	"getcontractstate--synopsis":                "Returns the latest indexed state for a SatoshiNet contract address.",
	"getcontractstate-address":                  "The contract address",
	"estimateevmdeploy--synopsis":               "Dry-runs an EVM contract deployment and estimates the required gas limit.",
	"estimateevmdeploy-request":                 "The EVM deploy estimate request object",
	"evmestimatedeployrequest-caller":           "The deployer wallet address",
	"evmestimatedeployrequest-initCodeHex":      "The EVM init code as 0x-prefixed hex",
	"evmestimatedeployrequest-value":            "Optional sats value sent to the constructor",
	"evmestimatedeployrequest-gasLimit":         "Optional initial gas limit to test",
	"evmestimatedeployrequest-deployNonce":      "Optional deploy nonce used to derive the contract address",
	"estimateevminvoke--synopsis":               "Dry-runs an EVM contract invoke and estimates the required gas limit.",
	"estimateevminvoke-request":                 "The EVM invoke estimate request object",
	"evmestimateinvokerequest-contractAddress":  "The EVM contract address",
	"evmestimateinvokerequest-caller":           "The caller wallet address",
	"evmestimateinvokerequest-calldataHex":      "The EVM calldata as 0x-prefixed hex",
	"evmestimateinvokerequest-value":            "Optional sats value sent to the contract",
	"evmestimateinvokerequest-gasLimit":         "Optional initial gas limit to test",
	"evmestimateinvokerequest-funding":          "Optional business funding assets",
	"evmestimatefundingasset-assetName":         "The funding asset name",
	"evmestimatefundingasset-amount":            "The funding asset amount",
	"estimateevminvokeresult-success":           "Whether the dry-run completed successfully",
	"estimateevminvokeresult-status":            "The dry-run status",
	"estimateevminvokeresult-gasUsed":           "The gas used by the successful dry-run, or the provided gas limit when out of gas",
	"estimateevminvokeresult-gasLimit":          "The gas limit used for the final dry-run",
	"estimateevminvokeresult-suggestedGasLimit": "Suggested gas limit with buffer when estimation succeeds",
	"estimateevminvokeresult-error":             "Execution error message, if any",
	"estimateevminvokeresult-returnDataHex":     "Hex-encoded EVM return data",
	"estimateevminvokeresult-contractAddress":   "The derived contract address for deploy estimates",
	"estimateevminvokeresult-runtimeCodeSize":   "The deployed runtime code size",
	"reviewpredictionready--synopsis":           "Reviews whether a prediction contract can pass oracle ready confirmation without changing chain state.",
	"reviewpredictionready-contractjson":        "The prediction contract JSON content",
	"reviewpredictionready-checkedat":           "Optional review time value. Height for height-based contracts, unix time for unix-based contracts.",
	"predictionreadyreviewresult-ready":         "Whether the prediction contract is ready for oracle confirmation",
	"predictionreadyreviewresult-urlReachable":  "Whether the configured source URL could be reached",
	"predictionreadyreviewresult-sourceUrl":     "The original configured source URL",
	"predictionreadyreviewresult-finalUrl":      "The final URL after redirects",
	"predictionreadyreviewresult-reason":        "The review reason when the contract is not ready",
	"predictionreadyreviewresult-textBytes":     "The number of fetched text bytes",
	"predictionreadyreviewresult-cleanedBytes":  "The number of cleaned text bytes",
	"predictionreadyreviewresult-checkedAt":     "The height or unix time used for the review",
	"getcontracthistory--synopsis":              "Returns indexed history for a SatoshiNet contract address.",
	"getcontracthistory-address":                "The contract address",
	"getcontracthistory-skip":                   "The number of history entries to skip",
	"getcontracthistory-count":                  "The maximum number of history entries to return",

	"txrawresult-contractOps":                 "Decoded SatoshiNet contract operations in this transaction",
	"txrawresult-contractStateRoot":           "The combined contract state root committed by this transaction, if present",
	"txrawdecoderesult-contractOps":           "Decoded SatoshiNet contract operations in this transaction",
	"txrawdecoderesult-contractStateRoot":     "The combined contract state root committed by this transaction, if present",
	"vout-contract":                           "SatoshiNet contract output information, if this output pays to a contract",
	"vout-Assets":                             "The assets carried by the output",
	"gettxoutresult-contract":                 "SatoshiNet contract output information, if this output pays to a contract",
	"gettxoutresult-Assets":                   "The assets carried by the output",
	"validateaddresschainresult-scriptPubKey": "The script public key for the address",
	"estimatesmartfeeresult-blocks":           "The number of blocks used for the estimate",
	"estimatesmartfeeresult-errors":           "Errors encountered while estimating the fee",
	"estimatesmartfeeresult-feerate":          "The estimated fee rate",
	"estimatesmartfee-estimatemode":           "The fee estimate mode",
	"estimatesmartfee-conftarget":             "The confirmation target",
	"estimatesmartfee--synopsis":              "Estimates a fee rate for confirmation within the requested target.",
	"getmempoolentryresult-depends":           "Transactions this mempool entry depends on",
	"getmempoolentryresult-fees":              "Fee details for the mempool entry",
	"getmempoolentryresult-wtxid":             "The witness transaction id",
	"getmempoolentryresult-ancestorfees":      "Fees for this transaction and its ancestors",
	"getmempoolentryresult-ancestorsize":      "Virtual size for this transaction and its ancestors",
	"getmempoolentryresult-ancestorcount":     "Number of unconfirmed ancestors",
	"getmempoolentryresult-descendantfees":    "Fees for this transaction and its descendants",
	"getmempoolentryresult-descendantsize":    "Virtual size for this transaction and its descendants",
	"getmempoolentryresult-descendantcount":   "Number of unconfirmed descendants",
	"getmempoolentryresult-height":            "The block height when the transaction entered the mempool",
	"getmempoolentryresult-time":              "The time when the transaction entered the mempool",
	"getmempoolentryresult-modifiedfee":       "The modified transaction fee",
	"getmempoolentryresult-fee":               "The transaction fee",
	"getmempoolentryresult-weight":            "The transaction weight",
	"getmempoolentryresult-size":              "The virtual transaction size",
	"getmempoolentryresult-vsize":             "The virtual transaction size",
	"getmempoolentry-txid":                    "The transaction id",
	"getmempoolentry--synopsis":               "Returns mempool data for a transaction.",
	"mempoolfees-descendant":                  "Fees for this transaction and its descendants",
	"mempoolfees-ancestor":                    "Fees for this transaction and its ancestors",
	"mempoolfees-modified":                    "Modified transaction fees",
	"mempoolfees-base":                        "Base transaction fee",
	"getblockstatsresult-utxo_size_inc":       "The UTXO set size increase",
	"getblockstatsresult-utxo_increase":       "The UTXO count increase",
	"getblockstatsresult-txs":                 "The number of transactions",
	"getblockstatsresult-total_weight":        "The total block weight",
	"getblockstatsresult-total_size":          "The total block size",
	"getblockstatsresult-total_out":           "The total output value",
	...
	"getblockstatsresult-swtotal_weight":      "The total segwit transaction weight",
	"getblockstatsresult-swtotal_size":        "The total segwit transaction size",
	"getblockstatsresult-outs":                "The number of outputs",
	"getblockstatsresult-mintxsize":           "The minimum transaction size",
	"getblockstatsresult-minfeerate":          "The minimum fee rate",
	"getblockstatsresult-minfee":              "The minimum fee",
	"getblockstatsresult-mediantxsize":        "The median transaction size",
	"getblockstatsresult-mediantime":          "The median block time",
	"getblockstatsresult-medianfee":           "The median fee",
	"getblockstatsresult-maxtxsize":           "The maximum transaction size",
	"getblockstatsresult-maxfeerate":          "The maximum fee rate",
	"getblockstatsresult-maxfee":              "The maximum fee",
	"getblockstatsresult-ins":                 "The number of inputs",
	"getblockstatsresult-height":              "The block height",
	"getblockstatsresult-blockhash":           "The block hash",
	"getblockstatsresult-feerate_percentiles": "Fee rate percentiles",
	"getblockstatsresult-avgtxsize":           "The average transaction size",
	"getblockstatsresult-avgfeerate":          "The average fee rate",
	"getblockstatsresult-avgfee":              "The average fee",
	"getblockstats-stats":                     "The statistics to return",
	"hashorheight-value":                      "The block hash or height",
	"getblockstats-hashorheight":              "The block hash or height",
	"getblockstats--synopsis":                 "Returns selected statistics about a block.",
	"getanchortxinforesult-amount":            "The locked anchor amount",
	"getanchortxinforesult-witness":           "The anchor witness",
	"getanchortxinforesult-anchortxid":        "The anchor transaction id",
	"getanchortxinforesult-lockedutxo":        "The locked UTXO",
	"getanchortxinfo-lockedutxo":              "The locked UTXO",
	"getanchortxinfo--synopsis":               "Returns SatoshiNet anchor transaction information.",
	"displayasset-BindingSat":                 "The asset binding sat value",
	"displayasset-Amount":                     "The asset amount",
	"displayasset-Name":                       "The asset name",
	"txrawresult-ascendInfo":                  "Ascend transaction information, if present",
	"ascendinfo-value":                        "The locked value",
	"ascendinfo-utxo":                         "The locked UTXO",
	"ascendinfo-txAssets":                     "The locked assets",
	"assetname-ticker":                        "The asset ticker",
	"assetname-type":                          "The asset type",
	"assetname-protocol":                      "The asset protocol",
	"prevout-Assets":                          "The assets carried by the previous output",

	"contracttxop-kind":                 "The contract transaction kind",
	"contracttxop-contractType":         "The contract type name",
	"contracttxop-contractTypeId":       "The numeric contract type id",
	"contracttxop-subtype":              "The contract subtype",
	"contracttxop-action":               "The invoked contract action",
	"contracttxop-gasLimit":             "The gas limit",
	"contracttxop-nonce":                "The deploy or call nonce",
	"contracttxop-contract":             "The contract address",
	"contracttxop-deployer":             "The deployer address",
	"contracttxop-templateName":         "The template name",
	"contracttxop-version":              "The contract or template version",
	"contracttxop-status":               "The result status",
	"contracttxop-resultCount":          "The number of result records",
	"contracttxop-payloadHex":           "The raw contract payload in hex",
	"contracttxop-details":              "Additional type-specific details",
	"contracttxop-details--desc":        "Additional detail key and value",
	"contracttxop-details--key":         "Additional detail key",
	"contracttxop-details--value":       "Additional detail value",
	"contractoutputinfo-vout":           "The output index",
	"contractoutputinfo-contract":       "The contract address",
	"contractoutputinfo-contractType":   "The contract type name",
	"contractoutputinfo-contractTypeId": "The numeric contract type id",
	"contractoutputinfo-version":        "The contract address version",
	"contractoutputinfo-hash":           "The contract address payload hash",
	"contractoutputinfo-value":          "The satoshi value",
	"contractoutputinfo-role":           "The output role",
	"contractstaterootinfo-combined":    "The combined contract state root",
	"contractinforesult-address":        "The contract address",
	"contractinforesult-contractType":   "The contract type name",
	"contractinforesult-contractTypeId": "The numeric contract type id",
	"contractinforesult-version":        "The contract address version",
	"contractinforesult-hash":           "The contract address payload hash",
	"contractinforesult-state":          "The latest contract state",
	"contractinforesult-details":        "Additional type-specific details",
	"contractinforesult-details--desc":  "Additional detail key and value",
	"contractinforesult-details--key":   "Additional detail key",
	"contractinforesult-details--value": "Additional detail value",
	"contracthistoryresult-address":     "The contract address",
	"contracthistoryresult-history":     "The contract history entries",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"generate":               {(*[]string)(nil)},
	"getanchortxinfo":        {(*btcjson.GetAnchorTxInfoResult)(nil)},
	...
	"getcontract":            {(*btcjson.ContractInfoResult)(nil)},
	"getcontracthistory":     {(*btcjson.ContractHistoryResult)(nil)},
	"getcontractstate":       {(*btcjson.ContractInfoResult)(nil)},
	"estimateevmdeploy":      {(*btcjson.EstimateEVMInvokeResult)(nil)},
	"estimateevminvoke":      {(*btcjson.EstimateEVMInvokeResult)(nil)},
	"reviewpredictionready":  {(*btcjson.PredictionReadyReviewResult)(nil)},
