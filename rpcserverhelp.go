...
var helpDescsEnUS = map[string]string{
	...
	// BTC Lucky Mining help.
	"getbtcluckymininginfo--synopsis":           "Returns BTC lucky mining status.",
	"getbtcluckymininginfo--result0":            "BTC lucky mining status object",
	"getbtcluckymininginfo--result0--desc":      "BTC lucky mining status object",
	"getbtcluckymininginfo--result0--key":       "Field name",
	"getbtcluckymininginfo--result0--value":     "BTC lucky mining status fields",
	"getbtcluckyhashrate--synopsis":             "Returns BTC lucky mining hashes per second.",
	"getbtcluckyhashrate--result0":              "The BTC lucky mining hash rate",
	"getbtctemplateserviceinfo--synopsis":       "Returns BTC template service status.",
	"getbtctemplateserviceinfo--result0":        "BTC template service status object",
	"getbtctemplateserviceinfo--result0--desc":  "BTC template service status object",
	"getbtctemplateserviceinfo--result0--key":   "Field name",
	"getbtctemplateserviceinfo--result0--value": "BTC template service status fields",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getbtcluckymininginfo":     {(*map[string]interface{})(nil)},
	"getbtcluckyhashrate":       {(*float64)(nil)},
	"getbtctemplateserviceinfo": {(*map[string]interface{})(nil)},
